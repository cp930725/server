<?php /*a:2:{s:74:"D:\phpstudy\PHPTutorial\WWW\test2\application\api\view\account\signup.html";i:1530868720;s:72:"D:\phpstudy\PHPTutorial\WWW\test2\application\api\view\common\hello.html";i:1527830792;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<?php if(empty(app('request')->param())): ?>
	<a href="https://fir.im/rm2g88">app下载</a>  已有账号了? <a href="/signin.html">立即登录</a>
<?php else: ?>
	<a href="https://fir.im/rm2g88">app下载</a>  已有账号了? <a href="/signin.html?<?php echo query(app('request')->query()); ?>">立即登录</a>
<?php endif; ?>
</div>
